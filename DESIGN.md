...
- Восемь карточек отрывков (три текущие истории и пять заглушек под новые тексты) собраны в бесконечную ленту на всю ширину: автоматическое движение справа налево, перетаскивание мышью и нативный свайп. Заголовки в рамках поверх арта справа сверху; вся карточка ведёт к произведению в текущей вкладке. При наведении, фокусе, взаимодействии и открытом диалоге автодвижение приостанавливается; учтены настройки уменьшенного движения; отдельная панель управления убрана. Копии карточек скрыты от экранных читалок и клавиатурного обхода.
...
Скорость ленты — 38 px/s. Видимая строка «Отрывки / Приостановить» убрана; остановка при наведении, фокусе и взаимодействии сохранена.
