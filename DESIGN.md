...
- Восемь карточек отрывков (три текущие истории и пять заглушек под новые тексты) собраны в бесконечную ленту на всю ширину: автоматическое движение справа налево, перетаскивание мышью и нативный свайп. Заголовки в рамках поверх арта справа сверху; вся карточка ведёт к произведению в текущей вкладке. При наведении, фокусе, взаимодействии и открытом диалоге автодвижение приостанавливается; есть кнопка паузы и поддержка уменьшенного движения. Копии карточек скрыты от экранных читалок и клавиатурного обхода.
...
- Сразу после первого экрана — приветствие автора на приглушённой тёмно-зелёной подложке: слева повёрнутая фотокарточка, справа курсивное приветствие и текст об авторе.
